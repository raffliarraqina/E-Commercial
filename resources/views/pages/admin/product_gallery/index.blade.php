    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                ...
                <a href="{{ route('dashboard.product.gallery.create', $product->id) }}" class="btn btn-primary ms-2">
            ...
            <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  @empty
                      <tr>
                        <td colspan="4" class="text-center">No Product Gallery</td>
                      </tr>
                  @endforelse
                </tbody>
              </table>
